        ...
        <div class="row">
            ...
            <div style="width: 600px; margin-left: 230px">
                <form:form action="${pageContext.request.contextPath}/savePost" modelAttribute="post">
                                  <form:textarea path="postBody" placeholder="What are you up to?" class="form-control" rows="5" id="comment"></form:textarea>

                                    <form:select  aria-labelledby="dropdownMenuButton" path="postLocation" cssStyle="color: gray; margin: 3px">
                                        <form:option value="" label= "Location"/>
                                        <form:options  items="${location}" itemLabel="location" itemValue="location"></form:options>
                                    </form:select>

                                    <form:select  aria-labelledby="dropdownMenuButton" path="isPrivate" cssStyle="color: gray; margin: 3px">
                                        <form:option value= "false" label= "Privacy"/>
                                        <form:option value="false" label= "Public"/>
                                        <form:option value="true" label= "privat"/>
                                    </form:select>
                                        ...
                                        <div class="col-md-11">
                                            <div class="media">
                                                <div class="media-body">
                                                    <a href="#" class="anchor-username"><h4 class="media-heading" style="color: yellow">${post.postBy}</h4></a>
                                                    <p class="anchor-time" style="color: #7abaff">${post.postTime}, ${post.postLocation}</p>
                                                </div>
                                                <div class="float-right">
                                                  <button class="btn"><a href="#"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></button>
                                                </div>
                                                <div class="float-right">
                                                    <button class="btn"><a href="#"><i class="fas fa-map-pin"></i></a></button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
